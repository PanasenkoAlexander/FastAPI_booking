...
from app.users.dependencies import get_current_user, get_admin
...
async def login_user(response: Response, user_data: SUserAuth):
    ...
    # создание и отправка токена в куки
...
async def read_users_all(current_user: Users = Depends(get_admin)):
